...
# 2.0 - General Settings
# 2.1 - Raw Folder Directory
if os.getcwd() != 'C:\\Python Downloads':
...
currentFolder = os.getcwd()+'\\'+today+' Auto_Download'       # I love this os module.
...
# 2.4 - File paths (The file path in os.chdir will have to be changed to match your Downloads folder)
# 2.4.1 - User Downloads Folder
cwdRawFolder = os.getcwd()
os.chdir("C:\\Python Downloads")
dwnloadFolder = os.getcwd()
#DestatisExcel = os.path.expanduser("D:\\Users\\" + getpass.getuser() + "\\Downloads\\Destatis ")
DestatisExcel = os.path.expanduser("C:\\Python Downloads")

# 2.4.2 - Firefox Mime Profile Directory
print('\tAccessing the Firefox download profile on the network. Expect some delay.\n')

# 2.5 - Setting Firefox browser prefernces
#myMimeType = "D:\\Users\\edwada\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\jy1vxldl.default" # Specifying the MIME type I saved in my Firefox profile
#myMimeType = "J:\\1) ADMIN\Documentation\\Profiles\\jy1vxldl.default"
myMimeType = "C:\\Users\\EDWARDS\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\d93TZgtL.default"
...
prf.set_preference("broswer.download.dir", cwdRawFolder)
